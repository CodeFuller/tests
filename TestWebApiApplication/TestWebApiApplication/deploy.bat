...
docker build -t test-web-api-application:1.0.13 -f Dockerfile .. || goto :error
docker tag test-web-api-application:1.0.13 codefuller/test-web-api-application:1.0.13 || goto :error
docker push codefuller/test-web-api-application:1.0.13 || goto :error
