...
docker build -t test-web-api-application:1.0.12 -f Dockerfile .. || goto :error
docker tag test-web-api-application:1.0.12 codefuller/test-web-api-application:1.0.12 || goto :error
docker push codefuller/test-web-api-application:1.0.12 || goto :error
